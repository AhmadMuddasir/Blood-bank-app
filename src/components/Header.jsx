    ...
    <h2 className=" bg-slate-500 rounded-md p-2">
      ...
      <div className='section_box  flex flex-col sm:flex-row items-center  p-4 m-4 justify-center' >
        ...
        <div className="sm:w-[50%]   flex justify-center items-start flex-col m-10">
          ...
          NOTE: <span className='font-bold text-xl underline'>USE SEPOLIA TEST NETWORK</span> as this website should be only manage by the Hospitals but you are a user so i have given you access to all the features of the WEB3 but in real life it will be manage by hospitals
          </p>
        </div>
